...
class PasienSearch extends Pasien
{
    ...
    {
        return [
            [['id_pasien', 'telp_pasien', 'id_poliklinik'], 'integer'],
            [['nama_pasien', 'alamat_pasien', 'jenis_kelamin', 'tanggal_lahir', 'tgl_pendaftaran'], 'safe'],
        ];
    }
    ...
    {
        $query = Pasien::find()->where(['id_poliklinik' => Yii::$app->user->identity->id_poliklinik]);
